...
U_4.4_indiv <- U_disc(r, t = y, utility = 
                        utility(n, consumption = (consumption(g, t = y, activity = activity(B, temp = temp(t = y, T))))))

#U_4.4 <- sum(utility(n, consumption = (consumption(g, 0, activity = activity(B, temp = temp(0, T))))):utility(n, consumption = (consumption(g, 200, activity = activity(B, temp = temp(200, T))))))

U_0 <- sum(utility(n, consumption = (consumption(g, t, activity = activity(B, temp = temp(t, T0))))))
...
L_sens_T <- abs((1 - ((utility(n, consumption = (consumption(g, t, activity = activity(B, temp = temp(t, (1.1*T)))))))/U_4.4)) * 100)

L_sens_g <- abs((1 - ((utility(n, consumption = (consumption((1.1*g), t, activity = activity(B, temp = temp(t, T))))))/U_4.4)) * 100)
