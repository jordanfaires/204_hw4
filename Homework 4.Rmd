...
L_sens_g <- abs(1 - (
  sum(U_disc(r, t = y, 
           utility = 
             utility(n, consumption = (consumption(g = (1.1*g), t = y, activity = activity(B, temp = temp(t = y, T))))))
  /
    sum(U_disc(r, t = y, 
           utility = 
             utility(n, consumption = (consumption(g = (1.1*g), t = y, activity = activity(B, temp = temp(t = y, 0)))))))))
    * 100)
